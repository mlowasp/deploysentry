...
h1{color:#39fff3;text-shadow:0 0 16px #39fff3} h2{color:#ff3df2}.card{border:1px solid #39fff3;box-shadow:0 0 18px #123b44;border-radius:12px;padding:18px;margin:16px 0;background:#090d18}
table{width:100%;border-collapse:collapse}td,th{border-bottom:1px solid #1e3d4a;padding:8px;text-align:left}.critical{color:#ff2e63}.high{color:#ff8a00}.medium{color:#ffd166}.low{color:#55ff99}.info{color:#39fff3} code{color:#55ff99}
</style></head><body><div class="wrap"><h1>DEPLOYSENTRY // Report</h1>
<div class="card"><h2>{{ r.target_domain }}</h2><p>Started: {{ r.started_at }}<br>Finished: {{ r.finished_at }}<br>Subdomains: {{ r.subdomains|length }}<br>Live services: {{ r.services|length }}</p></div>
